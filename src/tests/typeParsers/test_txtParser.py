...
def test_insert_newlines_txt():
    insert_newlines("src/tests/data/newlines_needed.txt", "src/tests/data/newlines_inserted.txt")
    with open("src/tests/data/newlines_inserted.txt", "r") as file:
        file.readline()
    ...
    with open("src/tests/data/newlines_inserted.txt", "w") as file:
        file.write("")
